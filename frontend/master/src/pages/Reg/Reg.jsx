...
function Reg() {
  ...
  const [rememberMe, setRememberMe] = useState(false); // For deciding whether to use localStorage or sessionStorage
    ...
    const registerUser = async (data) => {
      try {
        ...
        Swal.fire({
          ...
          padding: "3em",
          color: "#A59C9C",
          background: "#fff url(https://i.pinimg.com/564x/4a/b5/53/4ab553034fe9b99596db8d4117751cc1.jpg)",
          backdrop: `#ecf0f1`,
      ...
      <div className="relative flex flex-col m-4 space-y-6 bg-white shadow-xl rounded-xl md:flex-row md:space-y-0">
        ...
        <div className="flex flex-col justify-center p-6 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit"  className="w-full px-4 py-2 bg-greenRoot text-grayRoot rounded-md hover:bg-blue-700">Register</button>
          </form>
