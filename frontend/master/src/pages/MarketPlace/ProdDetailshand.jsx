...
const ProdDetailshand = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(`http://localhost:3001/api/handmade/gethandmade/${id}`);
        setProduct(response.data); // Updated to match the backend response
      } catch (error) {
...
export default ProdDetailshand;
